...
**Configuration:**
- `src/proxy/bully_d3d9proxy.ini` — template INI with defaults (backend=native; optional dxvk/on12, on12_device=internal, trace_device=1, capture_frames=0, capture_frontbuffer=0, capture_frame=60, mods.test_marker=0)
