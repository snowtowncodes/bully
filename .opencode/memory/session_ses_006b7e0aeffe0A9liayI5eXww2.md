...
ASSISTANT:
I’ll gather this from primary sources first: Microsoft’s D3D9On12 documentation, project repositories/releases, and published reverse-engineering or wrapper documentation. I’ll separate verified facts from inference, and include dates plus implementation entry points so the report is actionable.
</conversation_update>
