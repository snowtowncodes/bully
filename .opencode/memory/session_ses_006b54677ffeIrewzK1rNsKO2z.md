...
<conversation_update>
USER:
Research the current modding and decompilation ecosystem for Bully: Scholarship Edition (PC, RenderWare-based engine by Rockstar, 2008 port of the 2006 PS2 game, version 1.200 build from 2008-12-10).

Context: I am planning a modern rendering/mod platform on top of the PC game. Bully.exe imports DDRAW.dll and d3dx9_38 (classic RenderWare d3d9 driver pattern shared with GTA San Andreas PC). A local copy of the game sits in my project directory; this research is purely about external knowledge, do not touch any game files.
...
ASSISTANT:
I’m splitting the research into three tracks: established PC mods and communities, public decompilation/reimplementation efforts, and RenderWare/renderer reverse-engineering material. I’ll cross-check findings against primary repositories and preserved forum/wiki pages, and I’ll distinguish active projects from abandoned or merely mentioned ones.
</conversation_update>
